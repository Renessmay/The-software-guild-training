...
public class MoreBucketsMoreFun {
    public static void main(String[] args){
        ...
        // We are using -- operator to show that dog ate a bug
        butterflies--;
        System.out.println("Now there are only " + butterflies + " butterflies left.");
        
        /* 
            The number of bugs doesn't change because it has been calculated before the butterfly was eaten.
            We can calculate it again before printing  
            bugs = butterflies + beetles;
            Then bug number will be printed correctly.
        */
